...
//   bbd_logo_02.png              → logoKey
//   bbd_logo_slogan_02.png        → logoSloganKey
...
// Identify files using ASCII-only patterns
const logoKey       = keys.find(k => k.endsWith('bbd_logo_02.png')) ?? '';
const logoSloganKey = keys.find(k => k.endsWith('bbd_logo_slogan_02.png')) ?? '';

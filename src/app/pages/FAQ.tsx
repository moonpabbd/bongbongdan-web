...
const faqData: FAQCategory[] = [
  {
    ...
    items: [
      ...
      { q: '봉사 경험이 전혀 없는데 참여해도 되나요?', a: '적극 환영합니다! 봉봉단 참여자의 대부분이 처음 봉사를 시작하시는 분들입니다. 초보자분들도 쉽게 적응하실 수 있도록 운영진과 선배 단원들이 친절하게 안내해 드립니다.' },
  ...
  },
  {
    label: '멤버십 및 직급',
    items: [
      { q: '봉봉단의 직급(티어) 시스템은 무엇인가요?', a: '봉봉단은 누적 봉사 횟수에 따라 직급이 승급되는 무협지 컨셉의 재미있는 시스템을 운영하고 있습니다. (입문 단원 → 정식 단원 → 숙련 단원 등) 나의 현재 직급과 다음 승급까지 남은 횟수는 [나의 봉사] 페이지에서 확인하실 수 있습니다.' },
      { q: '단원 랭킹(순위)은 어떻게 결정되나요?', a: '역대 누적 봉사 횟수 및 시즌별 봉사 횟수를 기준으로 상위 10명의 단원들이 [명예·혜택] 페이지의 랭킹 보드에 등재됩니다. 꾸준한 활동을 통해 봉봉단의 전설적인 랭커가 되어보세요!' },
      { q: '운영진에게는 어떤 혜택이 있나요?', a: '봉봉단 운영에 기여하는 핵심 운영진(선봉대 제외)에게는 노고에 대한 감사의 의미로 참여하신 봉사 활동의 참가비를 전액 환급(지원)해 드리고 있습니다.' }
    ]
  },
  {
    label: '신청 및 일정',
    items: [
      { q: '봉사 일정을 변경하고 싶을 때는 어떻게 하나요?', a: '홈페이지 우측 상단 메뉴의 [나의 봉사] 페이지에서 직접 원하시는 일정으로 변경하실 수 있습니다. 단, 활동일로부터 최소 1주일(7일) 전까지만 가능하며, 잔여 정원이 남아있는 봉사 활동으로만 변경이 가능합니다.' },
      { q: '개인적인 사정으로 봉사를 취소해야 한다면요?', a: '봉봉단은 여러분의 현생을 가장 중요하게 생각합니다. 취소 시 운영진이나 단체 톡방에 따로 말씀하실 필요 없이, 홈페이지 우측 상단 메뉴의 [나의 봉사] 페이지에서 직접 취소하시거나 신청 당시 받으신 알림톡의 [봉사 출전 취소하기] 버튼을 통해 취소해 주시면 됩니다. 단, 개인 사정으로 인한 취소 시 봉사비 환불은 불가한 점 양해 부탁드립니다.' },
      { q: '회원가입을 꼭 해야 하나요?', a: '비회원으로도 신청이 가능합니다. 다만, 회원으로 가입하시면 매번 개인정보를 입력할 필요 없이 원클릭 신청이 가능하여 훨씬 편리합니다.' },
      { q: '사전 연락 없이 봉사에 불참(노쇼)하면 어떻게 되나요?', a: '무단 불참(노쇼)은 차량 배차 및 보호소 지원 인원 배분에 심각한 차질을 빚게 됩니다. 사전 취소 없이 불참하실 경우 향후 봉봉단 활동 참여가 영구적으로 제한될 수 있으며, 운영비로 사용되는 참가비는 환불되지 않습니다.' },
    ],
  },
  {
    label: '픽업',
    items: [
      ...
      { q: '집결지 도착 시간에 늦으면 어떻게 되나요?', a: '봉사 시작 시간보다 최소 10분 일찍 도착하는 것이 원칙입니다. 동승자로서 집결지에 지각하게 될 경우, 운전자의 판단에 따라 다른 동승자분들의 일정을 위해 과감하게 대기하지 않고 보호소로 먼저 출발할 수 있습니다. 이 경우 지각자는 개인적으로 보호소까지 이동하셔야 합니다. (지각으로 인한 불참 시에도 노쇼와 동일하게 처리됩니다.)' },
    ],
  },
  {
    label: '활동 가이드',
    items: [
      { q: '봉사 활동 시 복장과 준비물은 어떻게 되나요?', a: '흙먼지나 동물의 털 등으로 오염되어도 괜찮은 편한 옷과 운동화를 착용해 주세요. 기본적인 봉사 물품(방진복, 장갑, 마스크 등)은 현장에 구비되어 있습니다. 다만 더운 여름에는 땀 범벅이 될 수 있으니 여벌 옷을 챙겨오시는 것을 추천합니다.' },
